...
public class ContaEspecial extends Conta{
    ...
    public ContaEspecial(String numeroDaConta,PessoaFisica cliente,float chequeEspecial) {
    ...
    public void setCliente(Cliente cliente) {
        if (!cliente.eDoTipo(TipoCliente.PessoaFisica)) {
            throw new IllegalArgumentException("Conta Especial aceita apenas Pessoa Fisica");
        }
